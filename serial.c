...
#endif
{
	//printPgmString(PSTR("1ISR(USART_UDRE_vect)\r\n"));
...
uint8_t serial_read()
{
	//printPgmString(PSTR("serial_read()\r\n"));
...
#endif
{
	//printPgmString(PSTR("2ISR(USART_RX_vect)\r\n"));
  uint8_t data = UDR0;
  uint8_t next_head;
...
{
	//printPgmString(PSTR("3serial_reset_read_buffer()\r\n"));
